...
export const phonePartsProducts: Product[] = [
    ...
    },
    {
        ...
        rating: 4.8,
        reviews: 156,
        image: 'https://picsum.photos/seed/battery14/400/400',
    ...
    },
    {
        ...
        rating: 4.7,
        reviews: 45,
        image: 'https://picsum.photos/seed/camera13pro/400/400',
        inStock: true,
        brand: 'Apple',
    ...
    },
    {
        ...
        sold: 289,
        rating: 4.6,
        image: 'https://picsum.photos/seed/speaker12/400/400',
        inStock: true,
        brand: 'Apple',
        sku: 'LOA-IP12PM',
        warranty: '6 tháng'
...
export const ipadPartsProducts: Product[] = [
    {
        ...
        sold: 78,
        rating: 4.9,
        image: 'https://picsum.photos/seed/ipadpro129/400/400',
        inStock: true,
        isFeatured: true,
        brand: 'Apple',
...
export const glassSuppliesProducts: Product[] = [
    {
        ...
        sold: 1245,
        rating: 4.8,
        image: 'https://picsum.photos/seed/glass15pm/400/400',
        inStock: true,
        isHot: true,
        brand: 'Nillkin',
...
export const toolsEquipmentProducts: Product[] = [
    {
        ...
        sold: 45,
        rating: 4.9,
        image: 'https://picsum.photos/seed/machine890/400/400',
        inStock: true,
        isFeatured: true,
        brand: 'Sunshine',
        sku: 'MACHINE-SS890C'
    },
    {
        ...
        sold: 567,
        rating: 4.8,
        image: 'https://picsum.photos/seed/jackly120/400/400',
        inStock: true,
        isHot: true,
        brand: 'Jackly',
    ...
    },
    {
        ...
        sold: 890,
        rating: 4.7,
        image: 'https://picsum.photos/seed/uvlamp9w/400/400',
        inStock: true,
        brand: 'Generic',
        sku: 'UV-LAMP-9W'
    },
    ...
    },
    {
        ...
        sold: 1234,
        rating: 4.5,
        image: 'https://picsum.photos/seed/pliertool/400/400',
        inStock: true,
        isHot: true,
        brand: 'Generic',
        sku: 'PLIER-SCREEN'
