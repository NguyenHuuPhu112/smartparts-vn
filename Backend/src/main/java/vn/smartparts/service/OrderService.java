...
public class OrderService {
    ...
    public OrderDtos.OrderDto placeOrder(Long userId, Long addressId, PaymentMethod paymentMethod, BigDecimal shippingFee) {
    ...
    public List<OrderDtos.OrderDto> getOrdersOfUser(Long userId) {
        User user = userRepository.findById(userId)
                .orElseThrow(() -> new NoSuchElementException("User not found"));
    ...
    private OrderDtos.OrderDto toDto(Order order) {
